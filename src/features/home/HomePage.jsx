...
import NewestSection from "@/features/home/components/NewestSection";
import LatestArticles from "@/features/blog/components/LatestArticles";
import { Link } from "react-router-dom";
import Hero from "@/features/home/components/Hero";
import SuggestedSection from "@/features/home/components/SuggestedSection";
...
const HomePage = () => {
  ...
  if (loading) {
    return <PageLoader message="Loading amazing content..." />;
  }
      ...
      <div className="relative px-4 md:px-8 lg:px-12 -mt-10 z-10">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div variants={itemVariants} className="mb-12">
            <SuggestedSection items2={items2} title="Suggested For You" />
          </motion.div>
